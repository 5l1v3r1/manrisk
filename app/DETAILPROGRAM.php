...
class DETAILPROGRAM extends Model {
    ...
    protected $fillable = ['ID_DETAIL_PROGRAM', 'ID_JUDUL_PROGRAM', 'ID_ACTION_PLAN', 'UNIT_SASARAN', 'RENCANA_ANGGARAN', 'WAKTU_PELAKSANAAN', 'INDIKATOR_KEGIATAN', 'LUARAN_DAMPAK', 'STATUS_CAPAIAN', 'TAHUN', 'CREATED_AT', 'UPDATED_AT', 'CREATED_BY', 'DESKRIPSI_PROGRAM'];
