...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Judul Program</h1>
			</div>
		</div><!--/.row-->
					      ...
					      <tbody>
									@foreach ($data as $d)
										<tr>
											...
											<td>
												<a data-toggle="modal" data-idk="{{$d->id_judul_program}}" href="#myModal">
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
							<form class="form-horizontal" action='{{route('admin.master.program.edit')}}' method='post'>
									...
									<input type='hidden' name='id_judul_program' id='id_judul_program' value=''/>
